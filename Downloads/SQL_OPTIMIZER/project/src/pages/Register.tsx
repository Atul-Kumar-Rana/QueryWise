...
import { Mail, Lock, User, UserPlus, Database } from 'lucide-react';
      ...
      <div className="absolute inset-0">
        ...
        >
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-green-400 via-emerald-500 to-teal-600 rounded-full blur-2xl opacity-75"></div>
            <Database className="h-20 w-20 text-transparent bg-gradient-to-r from-green-400 via-emerald-500 to-teal-600 bg-clip-text relative z-10" />
          </div>
        </motion.div>
        ...
        >
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-red-500 to-pink-600 rounded-full blur-2xl opacity-75"></div>
            <Database className="h-16 w-16 text-transparent bg-gradient-to-r from-orange-400 via-red-500 to-pink-600 bg-clip-text relative z-10" />
          </div>
        </motion.div>
      </div>
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl font-bold bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent mb-2">
            Create Your QueryWise Account
          </h1>
          <p className="text-slate-300">Join thousands of developers optimizing their SQL queries</p>
        </motion.div>
        ...
        >
          ...
          <div className="mt-6 text-center">
            <p className="text-slate-300">
              ...
              <Link to="/login" className="text-transparent bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text hover:from-cyan-300 hover:to-purple-300 font-medium transition-all duration-300">
                Login
              </Link>
            </p>
          </div>
